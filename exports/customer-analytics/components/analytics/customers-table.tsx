      ...
      <div className="flex flex-col gap-3 border-b border-border p-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          <div className="relative">
            ...
            <Input
              placeholder="Search ID, DApp, country..."
              value={search}
        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              ...
              <TableHead className="text-[10px] uppercase">Operator</TableHead>
              <TableHead className="text-[10px] uppercase">Primary DApp</TableHead>
              <TableHead className="text-[10px] uppercase">Segment</TableHead>
              <TableHead className="text-[10px] uppercase">Lifecycle</TableHead>
              <TableHead className="text-right text-[10px] uppercase">LTV</TableHead>
              <TableHead className="text-right text-[10px] uppercase">Monthly Spend</TableHead>
