...
export const EXPORT_BUNDLES: ExportBundle[] = [
  ...
  },
  {
    id: "api-plugin",
    name: "API Plugin",
    description: "Data feed connectors — built-in analytics, REST JSON, CSV, internal API routes",
    route: null,
    npmCommand: "npm run exports:copy:plugin",
    files: [
      "lib/api-plugin/index.ts",
      "lib/api-plugin/types.ts",
      "lib/api-plugin/registry.ts",
      "lib/api-plugin/engine.ts",
      "lib/api-plugin/normalize.ts",
      "lib/api-plugin/data-feeds.ts",
      "lib/api-plugin/feed-builders.ts",
      "lib/data-stats.ts",
