...
export function CampaignPerformanceCharts({
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-2">
      <ChartContainer title="Campaign Lift" subtitle="BNRY earn efficiency by campaign">
        <ResponsiveContainer width="100%" height={240}>
          <BarChart data={campaignComparison} margin={{ top: 5, right: 5, left: 0, bottom: 0 }}>
            ...
            <Tooltip contentStyle={CHART_TOOLTIP_STYLE} formatter={(v) => [`${v}x`, "Lift"]} />
            <Bar dataKey="roas" name="Lift" radius={[4, 4, 0, 0]}>
